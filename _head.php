...
.wrap {
  max-width: 600px;
  margin: 0 auto;
  padding: 0.875rem 0.875rem calc(var(--nav-h) + 1.5rem);
}
.center-wrap {
  min-height: 100dvh;
...
.balance-stats {
  display: flex; gap: 1rem; margin-top: 1rem; position: relative; z-index: 1;
}
...
.wallet-edit-btn {
  ...
  border-radius: 4px; box-shadow: 1px 1px 0 rgba(0,0,0,0.15);
...
.chart-box {
  ...
  padding: 0.875rem; height: 210px; margin-bottom: 1rem;
}
...
.tx-item { display: flex; align-items: center; gap: 0.65rem; padding: 0.65rem 0.875rem; border-bottom: 1px solid var(--line); -webkit-tap-highlight-color: transparent; }
...
.nav-item {
  ...
  cursor: pointer; flex: 1; padding: 0.5rem;
...
@media (min-width: 520px) {
  .modal { border-radius: var(--r); box-shadow: var(--sh-l); animation: popIn .15s ease; }
...
.type-tab {
  ...
  box-shadow: var(--sh-s); transition: all 0.12s;
  -webkit-tap-highlight-color: transparent;
}
.type-tab .tab-icon { font-size: 20px; }
.type-tab.active-expense { background: var(--coral); color: #fff; border-color: var(--border); box-shadow: 2px 2px 0 var(--border); transform: translate(-1px,-1px); }
.type-tab.active-income  { background: var(--mint); color: var(--text); border-color: var(--border); box-shadow: 2px 2px 0 var(--border); transform: translate(-1px,-1px); }
.type-tab.active-transfer{ background: var(--blue); color: #fff; border-color: var(--border); box-shadow: 2px 2px 0 var(--border); transform: translate(-1px,-1px); }

/* ═══════════════════════════════════════════
   WALLET SELECTOR (Custom)
═══════════════════════════════════════════ */
...
.wallet-selector {
  ...
  padding-bottom: 0.3rem; margin-bottom: 0.875rem;
  scrollbar-width: none;
}
.wallet-selector::-webkit-scrollbar { display: none; }
.wsel-item {
  flex-shrink: 0; display: flex; flex-direction: column; align-items: center; gap: 0.3rem;
  padding: 0.5rem 0.65rem;
  border: 2px solid var(--border); border-radius: var(--r-s);
  background: var(--bg); cursor: pointer; font-size: 0.7rem; font-weight: 700;
  transition: all 0.12s; box-shadow: var(--sh-s);
  -webkit-tap-highlight-color: transparent;
  min-width: 64px;
}
.wsel-item img, .wsel-item .wsel-emoji {
...
.wsel-item.selected {
  background: var(--yellow); border-color: var(--border);
...
.amount-display {
  ...
  border-radius: var(--r-s); margin-bottom: 0.75rem;
}
...
.quick-btn {
  ...
  transition: all 0.08s; color: var(--text);
  -webkit-tap-highlight-color: transparent;
}
...
.numpad {
  ...
  gap: 0.45rem; margin-bottom: 0.875rem;
}
.nk {
  display: flex; align-items: center; justify-content: center;
  height: 52px; font-family: inherit; font-size: 1.1rem; font-weight: 700;
  border: 2px solid var(--border); border-radius: var(--r-s);
  background: var(--surface); cursor: pointer;
  box-shadow: var(--sh-s); transition: all 0.08s;
...
/* ═══════════════════════════════════════════
   SECTION CARD (chart wrapper, tx wrapper)
═══════════════════════════════════════════ */
...
.divider { height: 1px; background: var(--line); margin: 0.75rem 0; }
</style>
